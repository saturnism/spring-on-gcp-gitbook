...
You can use [Spring Cloud GCP Trace starter](trace.md#cloud-trace) to automatically read and use this trace header. In addition, use the [Spring Cloud GCP Logging starter](logging.md#logback) to automatically associate log entries with the Trace ID.
